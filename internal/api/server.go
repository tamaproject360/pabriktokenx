...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	s.mgmt.SetConfigSavedCallback(s.UpdateClients)
	if optionState.localPassword != "" {
		s.mgmt.SetLocalPassword(optionState.localPassword)
	}
	// Set log directory - use same logic as global_logger.go
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/auth-files/download-all", s.mgmt.BulkDownloadAuthFiles)
		mgmt.POST("/auth-files", s.mgmt.UploadAuthFile)
		mgmt.POST("/auth-files/bulk", s.mgmt.BulkUploadAuthFiles)
		...
		mgmt.POST("/gemini-web-auth-url", s.mgmt.RequestGeminiCookieToken)
