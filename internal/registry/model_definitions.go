...
func GetGeminiModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Description:                "Gemini 2.5 Flash optimized for image generation and visual understanding.",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
			SupportedGenerationMethods: []string{"generateContent", "countTokens", "createCachedContent", "batchGenerateContent"},
			Thinking:                   &ThinkingSupport{Min: 0, Max: 24576, ZeroAllowed: true, DynamicAllowed: true},
		},
		{
			...
			Description:                "Latest preview version of Gemini 3 Pro. Our best model for multimodal understanding, and our most powerful agentic and vibe-coding model yet.",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
			SupportedGenerationMethods: []string{"generateContent", "countTokens", "createCachedContent", "batchGenerateContent"},
...
// GetGeminiWebModels returns model definitions for Gemini Web (cookie-based authentication)
func GetGeminiWebModels() []*ModelInfo {
	return []*ModelInfo{
		{
			ID:                         "gemini-2.5-flash-image",
			Object:                     "model",
			...
			Version:                    "2.5",
			DisplayName:                "Gemini 2.5 Flash Image",
			Description:                "Gemini 2.5 Flash optimized for image generation and visual understanding. Requires cookie authentication.",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
		...
		},
		{
			...
			Description:                "Stable version of Gemini 2.5 Flash via web endpoint. Requires cookie authentication.",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
			SupportedGenerationMethods: []string{"generateContent", "countTokens"},
			Thinking:                   &ThinkingSupport{Min: 0, Max: 24576, ZeroAllowed: true, DynamicAllowed: true},
		},
		{
			...
			Description:                "Stable release of Gemini 2.5 Pro via web endpoint. Requires cookie authentication.",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
			SupportedGenerationMethods: []string{"generateContent", "countTokens"},
			Thinking:                   &ThinkingSupport{Min: 128, Max: 32768, ZeroAllowed: false, DynamicAllowed: true},
...
func GetGeminiCLIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Version:                    "3.1",
			DisplayName:                "Gemini 3.1 Pro Preview",
			Description:                "Latest preview version of Gemini 3 Pro. Our best model for multimodal understanding, and our most powerful agentic and vibe-coding model yet, delivering richer visuals and deeper interactivity.",
			InputTokenLimit:            1048576,
			OutputTokenLimit:           65536,
			SupportedGenerationMethods: []string{"generateContent", "countTokens", "createCachedContent", "batchGenerateContent"},
			Thinking:                   &ThinkingSupport{Min: 128, Max: 32768, ZeroAllowed: false, DynamicAllowed: true, Levels: []string{"low", "high"}},
...
func GetAntigravityModelConfig() map[string]*AntigravityModelConfig {
	return map[string]*AntigravityModelConfig{
		...
		"gemini-2.5-flash-image":                  {Thinking: &ThinkingSupport{Min: 0, Max: 24576, ZeroAllowed: true, DynamicAllowed: true}, Name: "models/gemini-2.5-flash-image"},
		...
		"gemini-3.1-pro-preview":                  {Thinking: &ThinkingSupport{Min: 128, Max: 32768, ZeroAllowed: false, DynamicAllowed: true, Levels: []string{"low", "high"}}, Name: "models/gemini-3.1-pro-preview"},
